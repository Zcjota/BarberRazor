...
<html>
	<head>
		...
		<title>Listado Comision Personal</title>		
	...
	<script src="DSListadoComisionP.js" type='text/javascript'></script>
	<script src="../DSforms/DSabmComision.js" type='text/javascript'></script>
	<style type="text/css">
		.x-grid3-row-alt {
