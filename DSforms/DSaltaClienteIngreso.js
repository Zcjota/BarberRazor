...
var txtNombreFactura_ac = new Ext.form.TextField({
	fieldLabel: 'Nombre Factura MOD 2',
...
var frmPropietario_ac = new Ext.FormPanel({
	...
	items: [
		...
		{ columnWidth: .20, layout: 'form', items: [txtFechaNacimiento] },
...
storePropietario_ac_peque = new Ext.data.JsonStore({
	...
	root: 'data',
	totalProperty: 'total',
	fields: ['codigob', 'codigop', 'nombrep', 'nit', 'razonsocial','feha_naci']
});
